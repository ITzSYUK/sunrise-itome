...
<template>
  ...
  >
    <template #button-group>
      <div class="md:flex gap-2 py-10 px-4 md:px-0">
        ...
        <a class="btn-red-outline px-15 w-full my2 md:w-80 flex justify-center items-center" :href="socials.whatsapp">
          Написать в WhatsApp
        </a>
      </div>
    </template>
  ...
  <section class="mt39 container">
    ...
    >
      <SwiperSlide v-for="car in 5" :key="car">
        <CarEntity />
      </SwiperSlide>
    </ListWithPagination>
  </section>
  ...
  <section class="mt39 container">
    ...
    <AutoCategories
      ...
      @select-tab="currentCategory = $event"
    />
